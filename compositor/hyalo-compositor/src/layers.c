...
layers_arrange(struct output *output)
{
	...
	/*
	 * Apply configured output margins only after exclusive layer-shell surfaces
	 * have been arranged, so the margin reserves work area for regular windows
	 * without shifting anchored panels away from the screen edge.
	 */
